...
male_avg_height = FOREACH male_data GENERATE AVG(male_data.height);
female_avg_height = FOREACH female_data GENERATE AVG(female_data.height);
...
DUMP (UNION male_avg_height,female_avg_height,female_over_60_count);
